...
const assets = [
  "/eat-while-pregnant-144x144.png",
  "/eat-while-pregnant-rich-install.png",
  "/entry.worker.js",
  "/favicon.ico"
];
const routes = {
  ...
  "routes/cachealytics_.index": {
    id: "routes/cachealytics_.index",
    parentId: "routes/cachealytics_",
    path: "index",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: true,
  ...
  "routes/api.set-pwa-banner": {
    id: "routes/api.set-pwa-banner",
    parentId: "root",
    path: "api/set-pwa-banner",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: true,
    hasAction: true,
  ...
  "routes/cachealytics_": {
    id: "routes/cachealytics_",
    parentId: "root",
    path: "cachealytics",
    index: void 0,
    caseSensitive: void 0,
